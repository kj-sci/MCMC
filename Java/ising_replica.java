...
public class ising_replica{
	...
	ising_replica(int this_L, int this_num, double[] t, String flg) {
	...
	public void init_parm(int this_L, int this_num, double[] t, String flg) {
		...
		if (flg.equals("temperture")) {
			...
			System.err.println("Error in ising_replica.init_param: flg="+flg);
		}
	...
	public void init_ising(String flg) {
		...
		for (int loop=0; loop<num_parms; loop++) {
			if (flg.equals("temperture")) {
				...
				System.err.println("Error in ising_replica.init_ising: flg="+flg);
			}
		}
	}
